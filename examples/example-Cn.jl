...
elseif  false
    ...
    # The sqrt(2J_f+1) that stood here by hand until 15-Sep-2026 is now applied INSIDE emmStaticAmplitude, where
    # Rule 18 says it belongs;  compensating at a call site is the drift that rule exists to stop.
    e2B = MultipoleMoment.emmStaticAmplitude(2, d5, s6, grB)
