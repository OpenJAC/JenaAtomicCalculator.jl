...
* Compute hydrogenic expectation values:$\qquad$                    ... demos/A9-Pluto-compute-hydrogenic-expectation-values.jl *(under construction)*

## Basic atomic structure calculations

* Define and use nuclear models:$\qquad$                            ... demos/B1-Pluto-define-nuclear-models.jl
* Compare different radial potentials:$\qquad$                      ... demos/B2-Pluto-compare-radial-potentials.jl *(under construction)*
...
* Expand levels into the LS-coupled basis:$\qquad$                  ... demos/B6-Pluto-expand-levels-into-LS-basis.jl *(under construction)*
...
* Generate a Green-function expansion:$\qquad$                      ... demos/C3-Pluto-generate-Green-expansion.jl *(under construction)*
...
* Compute atomic form factors:$\qquad$                              ... demos/D3-Pluto-compute-atomic-form-factors.jl *(under construction)*
* Estimate decay yields:$\qquad$                                    ... demos/D4-Pluto-estimate-decay-yields.jl *(under construction)*
* Compute an iron spectrum:$\qquad$                                 ... demos/D5-Pluto-compute-iron-spectrum.jl *(under construction)*
* Compute radiative recombination:$\qquad$                          ... demos/D6-Pluto-compute-radiative-recombination.jl *(under construction)*
* Compute DR resonance strengths:$\qquad$                           ... demos/D7-Pluto-compute-DR-resonance-strengths.jl *(under construction)*
* Compute Auger rates in a plasma:$\qquad$                          ... demos/D8-Pluto-compute-Auger-in-plasma.jl *(under construction)*
