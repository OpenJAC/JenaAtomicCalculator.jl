...
"""
`Statistical.computeTensorsPhotoExcitation(kmax::Int64, Ji::AngularJ64, fKey::LevelKey,`
    ...
    ... computes the statistical tensors of a level that has been EXCITED FROM AN UNPOLARIZED LEVEL Ji by plane-wave
        ...
        and passed to `computeTensors`.  Summing over M_i, M_f and M_f' explicitly costs nothing at these angular
...
"""
function computeTensorsPhotoExcitation(kmax::Int64, Ji::AngularJ64, fKey::LevelKey,
                            channels::Array{MultipoleAmplitude,1}, stokes::ExpStokes, gauge::Basics.EmGauge;
                            axis::Basics.AbstractQuantizationAxis=Basics.DefaultQuantizationAxis())
    Jf  = fKey.sym.J
    ...
    return( computeTensors(kmax, dm, fKey; axis=axis) )
end
